    ...
    public async Task<UserListDto> Handle(UpdateProfileCommand request, CancellationToken ct)
    {
        ...
        return new UserListDto(
            ...
            new UserPermissionsDto(
                ...
                user.CanReportOperatingCost,
                user.CanReportCostEvolution,
                user.CanReportCostRanking,
                user.CanReportRepairFrequency,
                user.CanReportMonthlyFuel,
                user.CanReportAiFleet,
                user.CanReportFuelEstimation,
                user.CanReportFuelComparison
            ),
            user.AlertAssurance,
