...
public class GetStopsReportQueryHandler : IRequestHandler<GetStopsReportQuery, StopsReportDto>
{
    ...
    public GetStopsReportQueryHandler(IGisDbContext context, ICurrentTenantService tenantService)
    {
        _context = context;
...
public class GetStopsReportAllVehiclesQueryHandler : IRequestHandler<GetStopsReportAllVehiclesQuery, List<StopsReportDto>>
{
    ...
    public GetStopsReportAllVehiclesQueryHandler(
    ...
    public async Task<List<StopsReportDto>> Handle(GetStopsReportAllVehiclesQuery request, CancellationToken ct)
    {
        ...
        // rendait le parc ENTIER de la société — chez un loueur, les arrêts des
        // véhicules d'autres locataires. scope == null => administrateur, aucun
        // filtre ; liste vide => aucun véhicule visible, donc rapport vide.
