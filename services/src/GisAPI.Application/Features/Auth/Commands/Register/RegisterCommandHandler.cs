    ...
    public async Task<LoginResponse> Handle(RegisterCommand request, CancellationToken ct)
    {
        ...
        if (defaultSubscriptionType != null)
        {
            subscriptionFeatures = new SubscriptionFeaturesDto(
                ...
                ModuleFuel: defaultSubscriptionType.ModuleFuel,
                ...
                ModuleTours: defaultSubscriptionType.ModuleTours,
                ReportTrips: defaultSubscriptionType.ReportTrips,
                ReportFuel: defaultSubscriptionType.ReportFuel,
                ReportSpeed: defaultSubscriptionType.ReportSpeed,
                ReportStops: defaultSubscriptionType.ReportStops,
                ReportMileage: defaultSubscriptionType.ReportMileage,
                ReportCosts: defaultSubscriptionType.ReportCosts,
                ReportMaintenance: defaultSubscriptionType.ReportMaintenance,
                ReportDaily: defaultSubscriptionType.ReportDaily,
                ReportMonthly: defaultSubscriptionType.ReportMonthly,
