...
public partial class AddUserRoleCompanyConstraint : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        // Database-level constraint: a user's role MUST belong to the same company
        // This prevents cross-company role assignment bugs permanently
        ...
        // Fix any existing orphaned role assignments
        migrationBuilder.Sql(@"
            UPDATE users u
            SET role_id = (
        ...
        // Ensure every company has at least one non-admin role
        migrationBuilder.Sql(@"
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(@"
            DROP TRIGGER IF EXISTS trg_user_role_company_check ON users;
            DROP FUNCTION IF EXISTS check_user_role_company();
        ");
    }
}
