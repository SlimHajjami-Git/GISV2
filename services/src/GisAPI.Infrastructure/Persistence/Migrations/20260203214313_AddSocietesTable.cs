...
{
    /// <inheritdoc />
    public partial class AddSocietesTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    description = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    target_company_type = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    monthly_price = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: false),
                    quarterly_price = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: false),
                    yearly_price = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: false),
                    monthly_duration_days = table.Column<int>(type: "integer", nullable: false),
                    quarterly_duration_days = table.Column<int>(type: "integer", nullable: false),
                    yearly_duration_days = table.Column<int>(type: "integer", nullable: false),
                    max_vehicles = table.Column<int>(type: "integer", nullable: false),
                    max_users = table.Column<int>(type: "integer", nullable: false),
                    max_gps_devices = table.Column<int>(type: "integer", nullable: false),
                    max_geofences = table.Column<int>(type: "integer", nullable: false),
                    gps_tracking = table.Column<bool>(type: "boolean", nullable: false),
                    gps_installation = table.Column<bool>(type: "boolean", nullable: false),
                    api_access = table.Column<bool>(type: "boolean", nullable: false),
                    advanced_reports = table.Column<bool>(type: "boolean", nullable: false),
                    real_time_alerts = table.Column<bool>(type: "boolean", nullable: false),
                    history_playback = table.Column<bool>(type: "boolean", nullable: false),
                    fuel_analysis = table.Column<bool>(type: "boolean", nullable: false),
                    driving_behavior = table.Column<bool>(type: "boolean", nullable: false),
                    history_retention_days = table.Column<int>(type: "integer", nullable: false),
                    sort_order = table.Column<int>(type: "integer", nullable: false),
                    is_active = table.Column<bool>(type: "boolean", nullable: false),
                    access_rights = table.Column<Dictionary<string, object>>(type: "jsonb", nullable: true),
                    report_trips = table.Column<bool>(type: "boolean", nullable: false),
                    report_fuel = table.Column<bool>(type: "boolean", nullable: false),
                    report_speed = table.Column<bool>(type: "boolean", nullable: false),
                    report_stops = table.Column<bool>(type: "boolean", nullable: false),
                    report_mileage = table.Column<bool>(type: "boolean", nullable: false),
                    report_costs = table.Column<bool>(type: "boolean", nullable: false),
                    report_maintenance = table.Column<bool>(type: "boolean", nullable: false),
                    report_daily = table.Column<bool>(type: "boolean", nullable: false),
                    report_monthly = table.Column<bool>(type: "boolean", nullable: false),
                    report_mileage_period = table.Column<bool>(type: "boolean", nullable: false),
                    report_speed_infraction = table.Column<bool>(type: "boolean", nullable: false),
                    report_driving_behavior = table.Column<bool>(type: "boolean", nullable: false),
                    module_dashboard = table.Column<bool>(type: "boolean", nullable: false),
                    module_monitoring = table.Column<bool>(type: "boolean", nullable: false),
                    module_vehicles = table.Column<bool>(type: "boolean", nullable: false),
                    module_employees = table.Column<bool>(type: "boolean", nullable: false),
                    module_geofences = table.Column<bool>(type: "boolean", nullable: false),
                    module_maintenance = table.Column<bool>(type: "boolean", nullable: false),
                    module_costs = table.Column<bool>(type: "boolean", nullable: false),
                    module_reports = table.Column<bool>(type: "boolean", nullable: false),
                    module_settings = table.Column<bool>(type: "boolean", nullable: false),
                    module_users = table.Column<bool>(type: "boolean", nullable: false),
                    module_suppliers = table.Column<bool>(type: "boolean", nullable: false),
                    module_documents = table.Column<bool>(type: "boolean", nullable: false),
                    module_accidents = table.Column<bool>(type: "boolean", nullable: false),
                    module_fleet_management = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    @if = table.Column<string>(name: "if", type: "text", nullable: true),
                    is_active = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    next_payment_amount = table.Column<decimal>(type: "numeric", nullable: true),
                    subscription_type_id = table.Column<int>(type: "integer", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_geofences_societes_company_id",
                table: "geofences",
                column: "company_id",
                principalTable: "societes",
                principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_gps_devices_societes_company_id",
                table: "gps_devices",
                column: "company_id",
                principalTable: "societes",
                principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_users_societes_company_id",
                table: "users",
                column: "company_id",
                principalTable: "societes",
                principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_vehicles_societes_company_id",
                table: "vehicles",
                column: "company_id",
                principalTable: "societes",
                principalColumn: "id",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    gps_tracking = table.Column<bool>(type: "boolean", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    MaxGeofences = table.Column<int>(type: "integer", nullable: false),
                    MaxGpsDevices = table.Column<int>(type: "integer", nullable: false),
