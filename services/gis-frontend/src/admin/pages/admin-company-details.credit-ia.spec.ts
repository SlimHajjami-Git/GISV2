...
/**
 * Fiche société admin — crédit IA mensuel du scan de factures (22/09/2026) : le champ
 * « nombre de scans » devient « Crédit IA mensuel (jetons) », avec la barre de
 * consommation du mois et l'équivalence en scans.
 */
describe('AdminCompanyDetailsComponent — crédit IA mensuel', () => {
  ...
  it('champ « Crédit IA mensuel (jetons) » prérempli du budget converti, équivalence en scans dessous', async () => {
    await preparer();

    expect(texte('label.scan-credit-label')).toBe('Crédit IA mensuel (jetons)');
