...
export class MockDataService {
  ...
  private initializeMockData() {
    ...
    const employees: Employee[] = [
      {
        ...
        employeeRole: 'driver',
        assignedVehicleId: 1,
        assignedVehicleName: 'Camion Tunis-1',
        assignedVehiclePlate: '192 TN 1234',
        status: 'active',
        hireDate: new Date('2023-06-01'),
        permitNumber: 'P123456',
        permitType: 'C',
        permitExpiry: new Date('2026-06-01'),
      },
      {
        id: 'emp2',
        companyId: 'comp1',
      ...
      },
      {
        ...
        employeeRole: 'driver',
        assignedVehicleId: 3,
        assignedVehicleName: 'Clio Location',
        assignedVehiclePlate: '192 TN 6789',
        status: 'active',
        hireDate: new Date('2024-01-10'),
        permitNumber: 'P789012',
        permitType: 'B',
    ...
    const rentalContracts: RentalContract[] = [
      {
        id: 'rent1',
        vehicleId: 'veh3',
        customerName: 'Karim Mhiri',
        customerContact: '+216 55 678 901',
    ...
    const vehicleCosts: VehicleCost[] = [
      ...
      { id: 'cost4', vehicleId: 'veh1', companyId: 'comp1', type: 'toll', description: 'Autoroute Tunis-Sousse', amount: 70, date: new Date('2024-12-10'), receiptNumber: 'TL-20241210' },
