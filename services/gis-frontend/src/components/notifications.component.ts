...
@Component({
    ...
    <app-layout>
      <div class="notifications-page">
        ...
        <div class="notif-filters">
          ...
          <button class="filter-btn" [class.active]="filterType === 'power_cut'" (click)="filterType = 'power_cut'; loadNotifications()">
          ...
          @for (notif of notifications; track notif.id) {
            <div class="notif-item" [class.unread]="!notif.isRead" (click)="openNotification(notif)">
              <div class="notif-icon" [class]="getNotifIconClass(notif.type)">
                ...
                <svg *ngIf="notif.type === 'power_cut'" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>
                <svg *ngIf="!['geofence','geofence_event','speed_alert','driving_behavior','maintenance_due','power_cut'].includes(notif.type)" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>
              </div>
  ...
  styles: [`
    ...
    .notif-icon.power_cut { background: #fef3c7; color: #f59e0b; }
    ...
    .notif-type-badge.power_cut { background: #fef3c7; color: #92400e; }
