      ...
      <div class="settings-page">
        ...
        <div class="settings-content">
          ...
          <div class="settings-panel">
            ...
            <!-- Remote Control: temporarily removed — re-enable when command delivery is fixed -->
...
export class FleetManagementComponent implements OnInit, OnDestroy {
  ...
  tabs = [
    ...
    // Remote control tab temporarily removed — re-enable when command delivery is fixed
  ];
  ...
  loadTabData() {
    ...
    switch (this.activeTab) {
      ...
      case 'parts':
        ...
        break;
      // case 'remote': temporarily removed
    }
  }
